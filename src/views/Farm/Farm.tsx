...
const Farm: React.FC = () => {
  ...
  return (
    <StyledPage>
      <Header>
        <Image src={`/images/tokens/category-${tokenSymbol || 'PIGGY'}.png`} alt={tokenSymbol} />
        <Title>{TranslateString(999, 'Stake LP tokens to earn PIGGY')}</Title>
      ...
      <StyledFarm>
        ...
        {dual ? (
          ...
          <StyledInfo>
            {TranslateString(
              590,
              '⭐️ Every time you stake and unstake LP tokens, the contract will automagically harvest PIGGY rewards for you!',
            )}
          </StyledInfo>
        )}
      </StyledFarm>
